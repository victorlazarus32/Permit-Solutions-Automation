"""
Connector: Village of Pinecrest -- PRR exports (manual upload).

Drop each new .xlsx into  inbox/pinecrest/  and run this connector
(or click "Process PRR" on the Operator Console).

NOTE: HEADER_ROW and COLUMN_MAP are placeholders. Verify against the first
real export from Pinecrest and adjust if column names differ.
"""
