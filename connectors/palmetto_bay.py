"""
Connector: Village of Palmetto Bay -- PRR exports (manual upload).

Drop each new .xlsx into  inbox/palmetto_bay/  and run this connector
(or click "Process PRR" on the Operator Console).

NOTE: HEADER_ROW and COLUMN_MAP are placeholders mirroring the Homestead PRR
template. Once Palmetto Bay sends the first real export, verify the column
names against this map and adjust if needed.
"""
...
SOURCE = "palmetto_bay"
HEADER_ROW = 0  # Palmetto Bay typical: headers on the first row
COLUMN_MAP = {
