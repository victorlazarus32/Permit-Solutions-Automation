"""
Connector: Town of Cutler Bay -- PRR exports (manual upload).

Drop each new .xlsx into  inbox/cutler_bay/  and run this connector
(or click "Process PRR" on the Operator Console).

NOTE: HEADER_ROW and COLUMN_MAP are placeholders. Verify against the first
real export from Cutler Bay and adjust if column names differ.
"""
